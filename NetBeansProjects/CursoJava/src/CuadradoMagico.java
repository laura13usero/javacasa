...
public class CuadradoMagico {
    ...
    public static void main(String[] args)  throws InterruptedException {
        ...
        System.out.println("De que tamano quieres el cuadrado:");
        int longitud = leer.nextInt();

        int[][] matriz = new int[longitud][longitud]; //Crear un matriz de 5 x 5
        ...
        //System.out.println("Voy a parar 5 segundos");
        //Thread.sleep(5000); Thread para parar el tiempo
        ...
        double promedio = sumaTotal / longitud*longitud;
        ...
        for (int i = 0; i < longitud; i++) {
            ...
            sumaDiagonales += matriz[i][longitud - 1 - i]; // Diagonal 2
        }
        ...
        if (esCuadradoMagico(matriz,longitud)) {
    ...
    public static boolean esCuadradoMagico(int[][] matriz, int longitud) {
        int sumaMagica = 0;
        for (int i = 0; i < longitud; i++) {
